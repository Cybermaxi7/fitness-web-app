                    ...
                    <div className="w-full lg:w-1/2 flex flex-col gap-4 items-start">
                       ...
                       <h3 className=" uppercase text-lg md:text-xl font-semibold border-b-2 border-b-green-500 mb-5 w-fit">
                        ...
                        <p className="text-sm md:text-lg">
                            ...
                            Benefit from detailed instructions, tips, and video
                            demonstrations for each exercise, ensuring proper
                            form and technique. Our team of fitness experts is
                            here to support you.
                        </p>
                        <p className="text-sm md:text-lg">
                            ...
                            equipment. Whatever your fitness goals, we've got
                            exercises to match.
                        </p>
                       </FadeInLeft>
                    </div>
                    ...
                    <div className="w-full lg:w-1/2 flex flex-col gap-4 items-start">
                       ...
                       <h3 className=" uppercase text-lg md:text-xl font-semibold border-b-2 border-b-green-500 mb-4 w-fit ">
                        ...
                        <p className="text-sm md:text-lg mb-2  font-medium">
                            <span className="font-bold">Browse Exercises:</span>{" "}
                            Discover a wide range of exercises categorized by
                            body part, difficulty, and equipment availability.
                        </p>
                        <p className="text-sm md:text-lg mb-2">
                            ...
                            demonstrations to master the correct form for each
                            exercise.
                        </p>
                        <p className="text-sm md:text-lg">
                            <span className="font-bold">
                            ...
                            Tailor your workout routine by selecting exercises
                            that match your preferences and fitness goals.
                        </p>
                       </FadeInLeft>
                    </div>
                    <div className="w-full lg:w-1/2">
                       ...
                       <h3 className=" uppercase text-lg md:text-xl font-semibold border-b-2 border-b-green-500 w-fit mb-4">
                        ...
                        <p className="text-sm md:text-lg">
                            Ready to embark on a journey to a healthier, more
                            active lifestyle? Dive into Exercise Hub and start
                            your fitness adventure today.
                        </p>
                        <Button
                    ...
                    <div className="w-full flex items-center justify-between gap-8 md:gap-16 flex-col lg:flex-row">
                        ...
                        <div className="flex items-start justify-between flex-col gap-10">
                            <p className="text-sm md:text-lg">
                                ...
                                I specialize in building web applications using modern technologies. My expertise includes front-end development, and I enjoy working on projects that challenge me to learn and grow.
